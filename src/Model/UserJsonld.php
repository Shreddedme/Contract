...
class UserJsonld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'createdBy' => 'int',
        'updatedBy' => 'int',
        'pet' => '\Bankiru\PetClient\Model\PetJsonld[]',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UserJsonld., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/^([a-zA-Z0-9\\s]*)$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling UserJsonld., must conform to the pattern /^([a-zA-Z0-9\\s]*)$/.");
        }
     ...
     * Gets pet
     *
     * @return \Bankiru\PetClient\Model\PetJsonld[]|null
     */
     ...
     * Sets pet
     *
     * @param \Bankiru\PetClient\Model\PetJsonld[]|null $pet pet
     *
     * @return self
     */
